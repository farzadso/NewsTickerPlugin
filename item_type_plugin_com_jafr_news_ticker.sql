...
/
prompt --application/shared_components/plugins/item_type/com_jafr_news_ticker
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(11034476670676558)
,p_plugin_type=>'ITEM TYPE'
,p_name=>'COM.JAFR.NEWS.TICKER'
,p_display_name=>'News Ticker 1.0'
,p_supported_ui_types=>'DESKTOP'
,p_plsql_code=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'FUNCTION f_render_news_ticker (',
...
'    v_page_item_name    VARCHAR2(100);  -- Item name (different from ID)',
'    v_html  VARCHAR2(4000); -- Used for temp HTML',
'    v_css   VARCHAR2(4000); -- Used for CSS',
'    v_settings  VARCHAR2(4000); --Used for plugin settings',
'    ',
'    -- Application Plugin Attributes',
'    ',
'    ',
'    -- Item Plugin Attributes',
'    v_title apex_application_page_items.attribute_01%type := p_item.attribute_01; -- The title of the Unordered List <ul>',
'    v_list_item_1  apex_application_page_items.attribute_02%type := p_item.attribute_02; -- List Item 1 <li>',
'    v_list_item_2  apex_application_page_items.attribute_03%type := p_item.attribute_03; -- List Item 2 <li>',
'    v_list_item_3  apex_application_page_items.attribute_04%type := p_item.attribute_04; -- List Item 3 <li>',
'    v_random    apex_application_page_items.attribute_05%type := p_item.attribute_05; --Whether to display the items in a random order or not',
'    v_itemSpeed    apex_application_page_items.attribute_06%type := p_item.attribute_06; -- Delay between displaying list items',
'    v_cursorSpeed   apex_application_page_items.attribute_07%type := p_item.attribute_07; -- Cursor speed for displaying characters',
'    v_pauseOnHover  apex_application_page_items.attribute_08%type := p_item.attribute_08; -- Pause on Hover',
'    v_fade  apex_application_page_items.attribute_09%type := p_item.attribute_09; -- Fade Effect',
'    v_fontSize  apex_application_page_items.attribute_10%type := p_item.attribute_10; -- Font Size',
'    v_color    apex_application_page_items.attribute_11%type := p_item.attribute_11; -- List Items Colour',
'',
'    -- Other variables',
'    ',
'  BEGIN',
...
'      -- Print News Ticker',
'      ',
'      -- Different List Item Variations',
'      IF v_list_item_2 IS NULL AND v_list_item_3 IS NULL THEN',
'      v_html := ''<div class="%ID%">',
'                    <strong>%TITLE%: </strong>',
'                        <ul>',
'                            <li>%LIST_ITEM1%</li>',
'                        </ul>',
'                 </div>'';',
'      v_html := REPLACE(v_html, ''%LIST_ITEM1%'', sys.htf.escape_sc(v_list_item_1));',
'      END IF;',
'      ',
'      IF v_list_item_3 IS NULL THEN',
'      v_html := ''<div class="%ID%">',
'                    <strong>%TITLE%: </strong>',
'                        <ul>',
'                            <li>%LIST_ITEM1%</li>',
...
'                 </div>''; ',
'      v_html := REPLACE(v_html, ''%LIST_ITEM1%'', sys.htf.escape_sc(v_list_item_1));',
'      v_html := REPLACE(v_html, ''%LIST_ITEM2%'', sys.htf.escape_sc(v_list_item_2));',
'      END IF;',
'      ',
'      IF v_list_item_2 IS NOT NULL AND v_list_item_3 IS NOT NULL THEN ',
'      v_html := ''<div class="%ID%">',
'                    <strong>%TITLE%: </strong>',
'                        <ul>',
'                            <li>%LIST_ITEM1%</li>',
...
'      v_html := REPLACE(v_html, ''%LIST_ITEM1%'', sys.htf.escape_sc(v_list_item_1));',
'      v_html := REPLACE(v_html, ''%LIST_ITEM2%'', sys.htf.escape_sc(v_list_item_2));',
'      v_html := REPLACE(v_html, ''%LIST_ITEM3%'', sys.htf.escape_sc(v_list_item_3));',
'      END IF;',
'      -- Set the title and HTML Class',
'      v_html := REPLACE(v_html, ''%ID%'', p_item.name);',
'      v_html := REPLACE(v_html, ''%TITLE%'', sys.htf.escape_sc(v_title));',
'   ',
'     ',
...
'      }</style>'';',
'          ',
'      v_css := REPLACE(v_css, ''%ID%'', p_item.name);',
'      v_css := REPLACE(v_css, ''%fontSize%'', v_fontSize);',
'      v_css := REPLACE(v_css, ''%color%'', v_color);',
'      ',
'      --The actual printing itself',
'      sys.htp.p(v_css);',
'      sys.htp.p(v_html);',
'       ',
'',
...
'      apex_javascript.add_library (p_name => ''jquery.ticker'', p_directory => p_plugin.file_prefix, p_version => null); -- Load jquery.ticker.js',
'          ',
'      -- Initialize the News Ticker',
'     ',
'      --Set Settings',
'      IF v_fade IS NULL THEN',
'          v_fade := ''true'';',
'      END IF;',
'      IF v_pauseOnHover IS NULL THEN',
'          v_pauseOnHover := ''true'';',
'      END IF;',
'      v_settings := ''$.fn.ticker.defaults = {',
'                    random:        %RANDOM%, // Whether to display ticker items in a random order',
'                    itemSpeed:     %itemSpeed%000,  // The pause on each ticker item before being replaced (miliseconds)',
'                    cursorSpeed:   %cursorSpeed%,    // Speed at which the characters are typed',
'                    pauseOnHover:  %pauseOnHover%,  // Whether to pause when the mouse hovers over the ticker',
'                    finishOnHover: false,  // Whether or not to complete the ticker item instantly when moused over',
'                    cursorOne:     "_",   // The symbol for the first part of the cursor',
'                    cursorTwo:     "-",   // The symbol for the second part of the cursor',
'                    fade:          %fade%,  // Whether to fade between ticker items or not',
'                    fadeInSpeed:   600,   // Speed of the fade-in animation',
'                    fadeOutSpeed:  300    // Speed of the fade-out animation',
'                };'';',
'      v_settings := REPLACE(v_settings, ''%RANDOM%'', v_random);',
'      v_settings := REPLACE(v_settings, ''%itemSpeed%'', v_itemSpeed);',
'      v_settings := REPLACE(v_settings, ''%cursorSpeed%'', v_cursorSpeed);',
'      v_settings := REPLACE(v_settings, ''%pauseOnHover%'', v_pauseOnHover);',
'      v_settings := REPLACE(v_settings, ''%fade%'', v_fade);',
'      apex_javascript.add_onload_code (p_code => v_settings);',
'      ',
'      -- Start the ticker',
'      v_html := ''$(".%ID%").ticker();'';',
'      v_html := REPLACE(v_html, ''%ID%'', p_item.name);',
...
'',
'Thanks to BenjaminRH for the jQuery Code',
'',
'JAFR - www.jafr.co'))
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11040514568831908)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11041468490184999)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11042294420209290)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11043067394224363)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11054081589405319)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11054649188406155)
,p_plugin_attribute_id=>wwv_flow_api.id(11054081589405319)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'true'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11055257337407057)
,p_plugin_attribute_id=>wwv_flow_api.id(11054081589405319)
,p_display_sequence=>20
,p_display_value=>'No'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11056023302468671)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_lov_type=>'STATIC'
,p_null_text=>'Seconds of Delay'
,p_help_text=>'The pause on each ticker item before being replaced (seconds)'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11056709593469879)
,p_plugin_attribute_id=>wwv_flow_api.id(11056023302468671)
,p_display_sequence=>10
,p_display_value=>'1'
,p_return_value=>'1'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11057037080470322)
,p_plugin_attribute_id=>wwv_flow_api.id(11056023302468671)
,p_display_sequence=>20
,p_display_value=>'2'
,p_return_value=>'2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11057648407470957)
,p_plugin_attribute_id=>wwv_flow_api.id(11056023302468671)
,p_display_sequence=>30
,p_display_value=>'3'
,p_return_value=>'3'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11058074050471324)
,p_plugin_attribute_id=>wwv_flow_api.id(11056023302468671)
,p_display_sequence=>40
,p_display_value=>'5'
,p_return_value=>'5'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11058445236471804)
,p_plugin_attribute_id=>wwv_flow_api.id(11056023302468671)
,p_display_sequence=>50
,p_display_value=>'10'
,p_return_value=>'10'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11058905090472249)
,p_plugin_attribute_id=>wwv_flow_api.id(11056023302468671)
,p_display_sequence=>60
,p_display_value=>'20'
,p_return_value=>'20'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11059311457472590)
,p_plugin_attribute_id=>wwv_flow_api.id(11056023302468671)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11060535102510968)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_lov_type=>'STATIC'
,p_null_text=>'Different Speeds'
,p_help_text=>'Speed at which the characters are typed'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11061148160512119)
,p_plugin_attribute_id=>wwv_flow_api.id(11060535102510968)
,p_display_sequence=>10
,p_display_value=>'Very Slow'
,p_return_value=>'200'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11061559999521991)
,p_plugin_attribute_id=>wwv_flow_api.id(11060535102510968)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11062009706522626)
,p_plugin_attribute_id=>wwv_flow_api.id(11060535102510968)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11062412831523124)
,p_plugin_attribute_id=>wwv_flow_api.id(11060535102510968)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11062797327523701)
,p_plugin_attribute_id=>wwv_flow_api.id(11060535102510968)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11064127166550557)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11064759633551221)
,p_plugin_attribute_id=>wwv_flow_api.id(11064127166550557)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'true'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11065205905551808)
,p_plugin_attribute_id=>wwv_flow_api.id(11064127166550557)
,p_display_sequence=>20
,p_display_value=>'No'
,p_return_value=>'false'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11067355269581033)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11067936818582027)
,p_plugin_attribute_id=>wwv_flow_api.id(11067355269581033)
,p_display_sequence=>10
,p_display_value=>'No'
,p_return_value=>'false'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11069504173680086)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11070090771681116)
,p_plugin_attribute_id=>wwv_flow_api.id(11069504173680086)
,p_display_sequence=>10
,p_display_value=>'Smallest'
,p_return_value=>'smallest'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11070458772681841)
,p_plugin_attribute_id=>wwv_flow_api.id(11069504173680086)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11070847036682780)
,p_plugin_attribute_id=>wwv_flow_api.id(11069504173680086)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11071306561685419)
,p_plugin_attribute_id=>wwv_flow_api.id(11069504173680086)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11071706550686504)
,p_plugin_attribute_id=>wwv_flow_api.id(11069504173680086)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(11072699814785713)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11073274576788077)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>10
,p_display_value=>'Aqua'
,p_return_value=>'aqua'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11073684275789296)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11074105813790499)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11074476386807652)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11074884610809430)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11075270853810797)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11075712250812113)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11076105543813094)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11076515704814036)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>90
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11076893279814779)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>100
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11077310020815951)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
,p_display_sequence=>110
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11077639630816644)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11078114300817304)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11078451018818193)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11078827148819618)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11079297205820732)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11079651157821816)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11080096151823883)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11080421526824544)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11080879459825190)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11081485884831907)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11081907791832682)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11082243814833204)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11082636666833749)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11083084723834316)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11083452716834997)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11084070555838085)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11084489481839607)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11084906594840519)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11085293817840969)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(11085712938841647)
,p_plugin_attribute_id=>wwv_flow_api.id(11072699814785713)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(11087885444999304)
,p_plugin_id=>wwv_flow_api.id(11034476670676558)
